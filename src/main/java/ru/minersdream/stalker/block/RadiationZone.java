...
public class RadiationZone extends BlockAir implements IHasModel{
	short lvl;
	public RadiationZone(String name, int lvl) {
		this.lvl=(short) lvl;
	...
	public void onEntityCollidedWithBlock(World worldIn, BlockPos pos, IBlockState state, Entity entityIn) {
		...
		if(player.getEntityData().getShort("RadiationZoneLevel")<this.lvl&&!player.isCreative()) {
			player.getEntityData().setShort("RadiationZoneLevel", lvl);
		}
