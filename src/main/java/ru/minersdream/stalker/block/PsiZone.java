...
public class PsiZone extends BlockAir implements IHasModel{
	short lvl;
	public PsiZone(String name, int lvl) {
		this.lvl=(short) lvl;
	...
	public void onEntityCollidedWithBlock(World worldIn, BlockPos pos, IBlockState state, Entity entityIn) {
		...
		if(player.getEntityData().getShort("PsiZoneLevel")<this.lvl&&!player.isCreative()) {
			player.getEntityData().setShort("PsiZoneLevel", lvl);
		}
