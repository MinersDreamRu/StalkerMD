...
public class BlockDocCase extends BlockDirectional implements IHasModel {
    protected static final AxisAlignedBB AABB_NS = new AxisAlignedBB(0.8D, 0.2D, 0.8D, 0.2D, 0.0D, 0.2D);
    protected static final AxisAlignedBB AABB_EW = new AxisAlignedBB(0.8D, 0.2D, 0.8D, 0.15D, 0.0D, 0.2D);


	public BlockDocCase(String name) {
