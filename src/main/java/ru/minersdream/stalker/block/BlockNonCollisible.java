...
public class BlockNonCollisible extends BaseObjDirectionalBlock{ 
	
    //public static final PropertyDirection FACING = BlockHorizontal.FACING;


    public BlockNonCollisible(String name) {
		super(name);
    ...
    public void addCollisionBoxToList(IBlockState state, World worldIn, BlockPos pos, AxisAlignedBB entityBox,
    	...
    	addCollisionBoxToList(pos, entityBox, collidingBoxes, new AxisAlignedBB(0.0D, 0.0D, 0.0D, 1.0D, 0.0D, 1.0D));
    }
