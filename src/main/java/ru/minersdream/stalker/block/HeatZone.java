...
public class HeatZone extends BlockAir implements IHasModel{
	short lvl;
	public HeatZone(String name, int lvl) {
		this.lvl=(short) lvl;
	...
	public void onEntityCollidedWithBlock(World worldIn, BlockPos pos, IBlockState state, Entity entityIn) {
		...
		if(player.getEntityData().getShort("HeatZoneLevel")<this.lvl&&!player.isCreative()) {
			player.getEntityData().setShort("HeatZoneLevel", lvl);
		}
