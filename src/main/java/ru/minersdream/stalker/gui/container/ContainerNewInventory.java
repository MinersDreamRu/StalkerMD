package ru.minersdream.stalker.gui.container;
...
import ru.minersdream.stalker.gui.InventoryPlayerCrafting;
...
public class ContainerNewInventory extends ContainerPlayer {
	...
	public ContainerNewInventory(InventoryPlayerCrafting playerInventory, boolean localWorld, EntityPlayer player) {
		...
		this.addSlotToContainer(
				new SlotCrafting(playerInventory.player, this.craftMatrix, this.craftResult, 0, 154, 24));
		int x, y, slot;
	...
	public ItemStack transferStackInSlot(EntityPlayer playerIn, int index) {
		...
		if (slot != null && slot.getHasStack()) {
			...
			} else if (equipmentslottype == EntityEquipmentSlot.OFFHAND
					&& !this.inventorySlots.get(SHIELD).getHasStack()) {
				// to shield slot
