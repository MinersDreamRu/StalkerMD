...
public class ContainerInventoryMarket extends ContainerPlayer {
	  ...
	  public ContainerInventoryMarket(InventoryPlayerCrafting playerInventory, boolean localWorld, EntityPlayer player) {
